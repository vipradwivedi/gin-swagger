...
import (
	...
	v1 "github.com/vipradwivedi/gin-swagger/example/multiple/api/v1"
	v2 "github.com/vipradwivedi/gin-swagger/example/multiple/api/v2"
	_ "github.com/vipradwivedi/gin-swagger/example/multiple/docs"
)
